  ...
  return (
    <section className="w-full bg-[#fafafa] text-[#090909] py-10 sm:py-16 md:py-20 font-sans border-b border-black/10">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6">
        {/* Solid White Studio Card Container matching BuildVaultPage design */}
        <div className="relative rounded-3xl bg-white text-[#090909] border border-black/15 p-6 sm:p-10 md:p-12 overflow-hidden text-left space-y-8 shadow-xl group">
          ...
          <div className="relative space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight uppercase text-[#090909] font-sans leading-tight">
              BUILDER OF THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#090909] via-black to-[#22C55E]">COHORT</span>
            </h2>

            <p className="text-sm sm:text-base md:text-lg text-[#333333] font-sans leading-relaxed">
              Every Turing Wings cohort awards <strong className="text-[#090909]">ONE Builder of the Cohort</strong> title. This distinction is awarded to the learner demonstrating the strongest combination of consistency, technical execution, project building, learning in public, and overall contribution.
            </p>
          </div>

          {/* ── THE REWARDS GRID (MATCHING BUILDVAULT FEATURE HIGHLIGHTS GRID) ── */}
          <div className="relative space-y-4 pt-2 border-t border-black/10">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-[#1ea34d] font-bold">1 Winner Per Cohort Batch</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {/* Reward 1: Hall of Fame (Featured) */}
              <div className="flex items-start gap-3.5 bg-[#F8F9FA] border border-black/10 p-3.5 sm:p-4 rounded-2xl shadow-xs hover:border-black/25 transition-all">
                <div className="w-9 h-9 rounded-xl bg-[#22C55E]/15 border border-[#22C55E]/30 flex items-center justify-center text-[#22C55E] shrink-0 mt-0.5">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#1ea34d]">Permanent</span>
                  </div>
              ...
              {/* Reward 2: Claude Pro */}
              <div className="flex items-start gap-3.5 bg-[#F8F9FA] border border-black/10 p-3.5 sm:p-4 rounded-2xl shadow-xs hover:border-black/25 transition-all">
                <div className="w-9 h-9 rounded-xl bg-[#22C55E]/15 border border-[#22C55E]/30 flex items-center justify-center text-[#22C55E] shrink-0 p-2 mt-0.5">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#1ea34d]">₹2,000+ Value</span>
                  </div>
                  <p className="text-xs text-[#555555] leading-relaxed">
              ...
              <div className="flex items-start gap-3.5 bg-[#F8F9FA] border border-black/10 p-3.5 sm:p-4 rounded-2xl shadow-xs hover:border-black/25 transition-all">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#1ea34d]">₹3,000+ Value</span>
                  </div>
                  <p className="text-xs text-[#555555] leading-relaxed">
              ...
              <div className="flex items-start gap-3.5 bg-[#F8F9FA] border border-black/10 p-3.5 sm:p-4 rounded-2xl shadow-xs hover:border-black/25 transition-all">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#1ea34d]">Official Credential</span>
                  </div>
                  <p className="text-xs text-[#555555] leading-relaxed">
          ...
          {/* ── CTA BUTTON MATCHING BUILDVAULT CTA ── */}
          <div className="relative pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
            <button
              onClick={toggleExpand}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#090909] text-white border border-[#090909] font-bold text-xs sm:text-sm uppercase tracking-wider hover:bg-[#22C55E] hover:text-black hover:border-[#22C55E] transition-all duration-300 shadow-xl cursor-pointer"
            ...
            {isExpanded && (
              ...
              >
                <div className="space-y-6 pt-6 border-t border-black/10">
                  <div className="space-y-1">
                    <span className="text-xs font-mono font-bold text-[#1ea34d] uppercase tracking-wider block">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#F8F9FA] border border-black/10 rounded-2xl p-5 space-y-3 shadow-xs">
                      <div className="flex items-center justify-between border-b border-black/10 pb-3">
                        ...
                        <span className="px-2.5 py-0.5 rounded-full bg-[#22C55E]/15 border border-[#22C55E]/30 text-xs font-mono font-bold text-[#1ea34d]">
                          30 PTS
                        </span>
                      </div>
                      <ul className="space-y-2 text-xs font-sans text-[#333333]">
                        <li className="flex items-center justify-between">
                          <span>Weekly/module assessments</span>
                          <span className="font-mono font-bold text-[#1ea34d]">15 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Accuracy &amp; understanding</span>
                          <span className="font-mono font-bold text-[#1ea34d]">10 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Timely completion</span>
                          <span className="font-mono font-bold text-[#1ea34d]">5 pts</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-[#F8F9FA] border border-black/10 rounded-2xl p-5 space-y-3 shadow-xs">
                      ...
                      <ul className="space-y-2 text-xs font-sans text-[#333333]">
                        <li className="flex items-center justify-between">
                          <span>Completion of assigned projects</span>
                          <span className="font-mono font-bold text-[#1ea34d]">10 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Technical quality &amp; functionality</span>
                          <span className="font-mono font-bold text-[#1ea34d]">10 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                    ...
                    <div className="bg-[#F8F9FA] border border-black/10 rounded-2xl p-5 space-y-3 shadow-xs">
                      ...
                      <ul className="space-y-2 text-xs font-sans text-[#333333]">
                        <li className="flex items-center justify-between">
                          <span>Project showcase posts</span>
                          <span className="font-mono font-bold text-[#1ea34d]">8 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Consistency of updates</span>
                          <span className="font-mono font-bold text-[#1ea34d]">6 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Technical explanation quality</span>
                          <span className="font-mono font-bold text-[#1ea34d]">4 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>Community engagement</span>
                          <span className="font-mono font-bold text-[#1ea34d]">2 pts</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-[#F8F9FA] border border-black/10 rounded-2xl p-5 space-y-3 shadow-xs">
                      ...
                      <ul className="space-y-2 text-xs font-sans text-[#333333]">
                        <li className="flex items-center justify-between">
                          <span>Problem definition &amp; originality</span>
                          <span className="font-mono font-bold text-[#1ea34d]">5 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                        ...
                        <li className="flex items-center justify-between">
                          <span>Effective AI/tool usage</span>
                          <span className="font-mono font-bold text-[#1ea34d]">5 pts</span>
                        </li>
                        <li className="flex items-center justify-between">
                          <span>User experience &amp; presentation</span>
                          <span className="font-mono font-bold text-[#1ea34d]">7 pts</span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="bg-[#F8F9FA] border border-black/10 rounded-2xl p-5 space-y-5 shadow-xs">
                    <div className="grid grid-cols-3 gap-3 text-center border-b border-black/10 pb-4 font-mono">
                      <div>
                        <div className="text-xl sm:text-3xl font-extrabold text-[#1ea34d]">100 PTS</div>
                      ...
                      <div>
                        <div className="text-xl sm:text-3xl font-extrabold text-[#1ea34d]">1 BUILDER</div>
                    ...
                    <div className="space-y-3 text-xs text-[#333333] font-sans">
                      <div className="flex items-start gap-2.5 bg-white border border-black/10 rounded-xl p-3.5">
                        <ShieldAlert className="w-4 h-4 text-[#1ea34d] shrink-0 mt-0.5" />
                        <p>
